...
export function CreateTournamentModal({ onClose, onCreateTournament, organizerName, organizerAvatar }: CreateTournamentModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-start sm:items-center justify-center overflow-y-auto z-[9999] p-3 sm:p-4">
      <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-2xl w-full max-w-3xl max-h-[92vh] flex flex-col border border-[#00d4ff]/20 shadow-2xl shadow-[#00d4ff]/10">
        {/* Header */}
        <div className="relative p-4 border-b border-white/5 flex-shrink-0">
          <div className="absolute inset-0 bg-gradient-to-r from-[#00d4ff]/5 to-purple-500/5"></div>
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="p-2 bg-gradient-to-br from-[#00d4ff] to-[#00a3cc] rounded-xl shadow-lg shadow-[#00d4ff]/20">
                <Trophy className="w-5 h-5 text-white" />
              </div>
              <div>
                <h2 className="text-xl font-bold text-white">Create Tournament</h2>
                <p className="text-white/50 text-xs">Host your own League of Legends tournament</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          {/* Progress Steps */}
          <div className="relative flex items-center justify-between mt-6 px-20">
            {[1, 2, 3].map((stepNum, index) => (
              <React.Fragment key={stepNum}>
                <div className="flex flex-col items-center gap-2 relative z-10">
                  <div className={`w-16 h-16 rounded-full flex items-center justify-center font-bold transition-all duration-300 text-2xl border-[6px] ${
                    step >= stepNum 
                  ...
                  <span className={`text-sm font-bold ${step >= stepNum ? 'text-white' : 'text-white/30'}`}>
                    {stepNum === 1 ? 'Basic Info' : stepNum === 2 ? 'Settings' : 'Details'}
                  </span>
                </div>
                {index < 2 && (
                  <div className={`flex-1 h-1.5 mx-12 transition-all duration-300 rounded-full ${
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0a0e1a]/50 border border-white/10 rounded-lg px-3 py-2 text-white text-sm placeholder:text-white/40 focus:outline-none focus:border-[#00d4ff]/50"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full bg-[#0a0e1a]/50 border border-white/10 rounded-lg pl-8 pr-3 py-2 text-white text-sm placeholder:text-white/40 focus:outline-none focus:border-green-400/50"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0a0e1a]/50 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-[#00d4ff]/50"
                  />
                </div>
                <div>
                  <label className="flex items-center gap-1.5 text-white text-xs font-medium mb-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0a0e1a]/50 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-purple-400/50"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2.5">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#0a0e1a]/50 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-yellow-500/50"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                <div>
                  <label className="flex items-center gap-1.5 text-white text-xs font-medium mb-1.5">
                    ...
                    {teamSize === '1v1' ? 'Max Players *' : 'Max Teams *'}
                  </label>
                  <select
                    value={maxTeams}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <div className="p-2.5 rounded-lg border-2 bg-[#00d4ff]/10 border-[#00d4ff] text-white">
            ...
            <div className="space-y-2.5">
              ...
              <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-lg p-2.5">
                ...
                <div className="bg-[#0a0e1a]/50 border border-green-500/20 rounded-lg p-2 mb-2 text-center">
                  ...
                  <p className="text-lg sm:text-xl md:text-2xl font-bold text-green-400">€{parseFloat(prize || '0').toFixed(2)}</p>
                </div>

                {/* Prize Splits */}
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 mb-2">
                  <div className="bg-[#0a0e1a]/30 border border-yellow-500/20 rounded-lg p-2">
                    <div className="text-center mb-1.5">
                      <span className="text-xl block mb-0.5">🥇</span>
                      <p className="text-white/60 text-[9px]">1st Place</p>
                    </div>
                    <input
                      type="number"
                      min="0"
                      ...
                      onChange={(e) => setPrizeDistribution({ ...prizeDistribution, first: e.target.value })}
                      className="w-full bg-[#0a0e1a] border border-white/10 rounded px-1.5 py-1 text-white text-center text-xs font-bold focus:outline-none focus:border-yellow-400/50 mb-1"
                      placeholder="%"
                    />
                    <p className="text-yellow-400 font-bold text-center text-xs">
                      €{((parseFloat(prize || '0') * parseFloat(prizeDistribution.first || '0')) / 100).toFixed(2)}
                    </p>
                  </div>

                  <div className="bg-[#0a0e1a]/30 border border-gray-400/20 rounded-lg p-2">
                    <div className="text-center mb-1.5">
                      <span className="text-xl block mb-0.5">🥈</span>
                      <p className="text-white/60 text-[9px]">2nd Place</p>
                    </div>
                    <input
                      type="number"
                      min="0"
                      ...
                      onChange={(e) => setPrizeDistribution({ ...prizeDistribution, second: e.target.value })}
                      className="w-full bg-[#0a0e1a] border border-white/10 rounded px-1.5 py-1 text-white text-center text-xs font-bold focus:outline-none focus:border-gray-400/50 mb-1"
                      placeholder="%"
                    />
                    <p className="text-gray-300 font-bold text-center text-xs">
                      €{((parseFloat(prize || '0') * parseFloat(prizeDistribution.second || '0')) / 100).toFixed(2)}
                    </p>
                  </div>

                  <div className="bg-[#0a0e1a]/30 border border-orange-500/20 rounded-lg p-2">
                    <div className="text-center mb-1.5">
                      <span className="text-xl block mb-0.5">🥉</span>
                      <p className="text-white/60 text-[9px]">3rd Place</p>
                    </div>
                    <input
                      type="number"
                      min="0"
                      ...
                      onChange={(e) => setPrizeDistribution({ ...prizeDistribution, third: e.target.value })}
                      className="w-full bg-[#0a0e1a] border border-white/10 rounded px-1.5 py-1 text-white text-center text-xs font-bold focus:outline-none focus:border-orange-400/50 mb-1"
                      placeholder="%"
                    />
                    <p className="text-orange-400 font-bold text-center text-xs">
                      €{((parseFloat(prize || '0') * parseFloat(prizeDistribution.third || '0')) / 100).toFixed(2)}
                    </p>
                  </div>
                </div>
                    ...
                    <div className={`rounded-lg p-1.5 ${
                      ...
                      <div className="flex items-center justify-between">
                        <span className={`text-xs font-bold ${total === 100 ? 'text-green-400' : 'text-red-400'}`}>
                          {total === 100 ? '✓ Perfect!' : '⚠ Must equal 100%'}
                        </span>
                        <span className={`text-base font-bold ${total === 100 ? 'text-green-400' : 'text-red-400'}`}>
                          {total}%
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xl font-bold text-yellow-400">€{parseFloat(prize || '0').toFixed(2)}</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-2">
                      <p className="text-yellow-400 text-[10px] flex items-start gap-1.5">
                        ...
                        <span>
                          By adding prize money, you commit to distributing €{parseFloat(prize || '0').toFixed(2)} to winners.
                        </span>
                      </p>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full px-3 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white text-sm rounded-lg hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed font-bold"
                    >
        ...
        {/* Footer */}
        <div className="p-4 border-t border-white/5 bg-[#0a0e1a]/30 flex-shrink-0">
          <div className="flex items-center justify-between gap-3">
            <button
              onClick={step === 1 ? onClose : () => setStep(step - 1)}
              className="px-5 py-2 bg-white/5 text-white text-sm rounded-lg hover:bg-white/10 transition-all duration-200"
            >
              {step === 1 ? 'Cancel' : 'Back'}
            </button>
            ...
            <div className="flex items-center gap-2.5">
              {step < 3 ? (
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-[#00d4ff] to-[#00a3cc] text-white text-sm rounded-lg hover:shadow-lg hover:shadow-[#00d4ff]/30 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
                >
                  Next Step
                </button>
              ) : (
                <>
                  {!moneyAdded ? (
                    <button
                      onClick={() => setShowPaymentModal(true)}
                      disabled={!isStep3Valid}
                      className="px-6 py-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white text-sm rounded-lg hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed font-medium flex items-center gap-1.5"
                    >
                      <DollarSign className="w-4 h-4" />
                      Add €{parseFloat(prize || '0').toFixed(2)}
                    </button>
                  ) : (
                    <button
                      onClick={handleSubmit}
                      className="px-6 py-2 bg-gradient-to-r from-[#00d4ff] to-[#00a3cc] text-white text-sm rounded-lg hover:shadow-lg hover:shadow-[#00d4ff]/30 transition-all duration-300 font-medium flex items-center gap-1.5"
                    >
      ...
      {/* Payment Modal */}
      {showPaymentModal && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-start sm:items-center justify-center overflow-y-auto z-[10000] p-3 sm:p-4">
          <div className="bg-gradient-to-br from-[#1a1d29] to-[#151821] rounded-2xl w-full max-w-2xl max-h-[85vh] flex flex-col border border-green-500/20 shadow-2xl shadow-green-500/10">
            {/* Header */}
            <div className="relative p-6 border-b border-white/5 bg-gradient-to-r from-green-500/10 to-emerald-500/10 flex-shrink-0">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white">Choose Payment Method</h3>
                  <p className="text-white/60 text-sm">Select your preferred way to pay €{parseFloat(prize || '0').toFixed(2)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 space-y-4 overflow-y-auto flex-1">
                  ...
                  <button
                    ...
                    className={`relative p-4 rounded-xl border-2 transition-all duration-300 group ${
                      paymentMethod === method.id
                        ? `bg-gradient-to-br from-[${method.color}]/20 to-[${method.color}]/10 border-[${method.color}] shadow-lg shadow-[${method.color}]/20`
                        : 'bg-[#0a0e1a]/50 border-white/10 hover:border-white/30 hover:bg-[#0a0e1a]/80'
                    }`}
                    style={{
                      borderColor: paymentMethod === method.id ? method.color : undefined
                    }}
                  >
                    <div className={`h-12 flex items-center justify-center mb-2 transition-all duration-300 ${
              ...
              {/* Payment Details */}
              <div className="bg-[#0a0e1a]/50 border border-white/10 rounded-xl p-5">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-white/60 text-sm font-medium">Payment Amount:</span>
                  <span className="text-xl sm:text-2xl md:text-3xl font-bold text-white">€{parseFloat(prize || '0').toFixed(2)}</span>
                </div>
                <div className="space-y-2 pt-4 border-t border-white/5">
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-white/50">🥇 1st Place ({prizeDistribution.first}%):</span>
                    <span className="text-white font-semibold">€{((parseFloat(prize || '0') * parseFloat(prizeDistribution.first || '0')) / 100).toFixed(2)}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-white/50">🥈 2nd Place ({prizeDistribution.second}%):</span>
                    <span className="text-white font-semibold">€{((parseFloat(prize || '0') * parseFloat(prizeDistribution.second || '0')) / 100).toFixed(2)}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-white/50">🥉 3rd Place ({prizeDistribution.third}%):</span>
                    <span className="text-white font-semibold">€{((parseFloat(prize || '0') * parseFloat(prizeDistribution.third || '0')) / 100).toFixed(2)}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-white/50 text-[10px]">256-bit encryption</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-white text-xs font-semibold">Instant Processing</p>
                      <p className="text-white/50 text-[10px]">Real-time verification</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Footer */}
            <div className="p-3 sm:p-4 md:p-6 border-t border-white/5 bg-[#0a0e1a]/30 flex-shrink-0">
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-white/5 text-white rounded-lg hover:bg-white/10 transition-all duration-200 font-medium disabled:opacity-50"
                >
                  {showPaymentForm ? 'Back to Methods' : 'Cancel'}
                </button>
                <button
                  onClick={() => setShowPaymentForm(true)}
                  disabled={isProcessingPayment}
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300 font-bold text-lg disabled:opacity-70"
                >
                  Continue to Payment
                </button>
              </div>
